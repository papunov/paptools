...
Този скил описва структурите и правилата за работа с **AI модулите**, **OCR обработката на бележки** и **фоновата автоматизация** в **PersonalManager**. Danните се генерират автоматично от фоновата Python услуга `PersonalManager-Data-Ingestion` и се съхраняват в MongoDB.
...
Услугата `Data-Ingestion` периодично изпълнява задачи за извличане на пазарни данни, БНБ курсове, генерация на AI анализи и обновяване на разходи. Всяко изпълнение записква статус в `JobStatuses`:
- `_id`: ObjectId
